...
namespace StoreFront.UI.MVC.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["MerchantId"] = new SelectList(_context.Merchants, "MerchantId", "MerchantAddress1");
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductPrice,ProductDescription,ProductStatusId,SeasonId,MerchantId,ProductImage,CategoryId")] Product product)
        {
            ...
            ViewData["MerchantId"] = new SelectList(_context.Merchants, "MerchantId", "MerchantAddress1", product.MerchantId);
