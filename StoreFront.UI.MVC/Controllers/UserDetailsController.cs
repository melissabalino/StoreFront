...
namespace StoreFront.UI.MVC.Controllers
{
    public class UserDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,Address1,Address2,City,State,Zip,Phone")] UserDetail userDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,FirstName,LastName,Address1,Address2,City,State,Zip,Phone")] UserDetail userDetail)
        {
